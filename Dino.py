...
musica_de_fundo = pygame.mixer.music.load(os.path.join(diretorio_sons, "musica Dino.mp3"))
...
som_colisao = pygame.mixer.Sound(os.path.join(diretorio_sons, "Bonk Dino.wav"))
...
class Dino(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.som_pulo = pygame.mixer.Sound(os.path.join(diretorio_sons, "Pulo-Dino.wav"))
        ...
        self.pos_y_incial = ALTURA - 64 - 96//2
    ...
    def update(self):
        if self.pulo == True:
           ...
           self.rect.y -= 15
            ...
            if self.rect.y < self.pos_y_incial:
                self.rect.y += 15
            else:
                self.rect.y = self.pos_y_incial
    ...
    for event in pygame.event.get():
        ...
        if event.type == KEYDOWN:
            if event.key == K_SPACE:
                if dino.rect.y != dino.pos_y_incial:
                   pass
                else:
                 dino.pular()
